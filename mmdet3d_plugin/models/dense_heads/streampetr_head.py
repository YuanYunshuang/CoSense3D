...
from mmdet3d_plugin.models.utils.positional_encoding import pos2posemb3d, pos2posemb1d, nerf_positional_encoding
...
class StreamPETRHead(AnchorFreeHead):
    ...
    def prepare_for_dn(self, batch_size, reference_points, img_metas):
        """
        During training, pad reference points with augmented gt_box centers to speed up training,
        generates masks that only attend the areas near the gt_box centers.
        """
    ...
    def forward(self, memory_center, img_metas, topk_indexes=None,  **data):
        ...
        memory = topk_gather(memory, topk_indexes)  # order to memery with topk_indexes
    ...
    def loss_single(self,
        ...
        # if loss_bbox.isnan().any() or loss_cls.isnan().any():
        #     print('d')
