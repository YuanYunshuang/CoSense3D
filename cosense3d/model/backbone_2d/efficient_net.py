# copied and modified from https://github.com/bradyz/cross_view_transformers
...
class EfficientNet(torch.nn.Module):
    ...
    def __init__(self, layer_names, image_height, image_width, model_name='efficientnet-b4'):
        ...
        net = ENet.from_pretrained(model_name)
        net.set_swish(False)
...
if __name__ == '__main__':
    ...
    dummy = torch.rand(2, 3, 640, 960).to(device)

    for model_name in ['efficientnet-b0', 'efficientnet-b5']:
        net = ENet.from_pretrained(model_name)
        net = net.to(device)
        net.set_swish(False)
