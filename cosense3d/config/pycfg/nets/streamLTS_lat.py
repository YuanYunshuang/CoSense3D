...
from cosense3d.config.pycfg.template.query_guided_petr_head import get_query_guided_pred_head_cfg
...
def get_shared_modules(point_cloud_range, global_ref_time=0, enc_dim=32):
    ...
    return OrderedDict(
        ...
        roi_head = dict(
            ...
            gt_keys=['local_bboxes_3d', 'local_labels_3d', 'local_bboxes_mask'],
            heads=[
        ...
        det1_head = get_query_guided_pred_head_cfg(
            gather_keys=['temp_fusion_feat'],
            scatter_keys=['detection_local'],
            gt_keys=['global_bboxes_3d', 'global_labels_3d', 'global_bboxes_id',
                     'local_bboxes_3d', 'local_labels_3d', 'local_bboxes_mask', 'local_bboxes_id'],
            voxel_size=voxel_size,
            point_cloud_range=point_cloud_range,
        ...
        det2_head = get_query_guided_pred_head_cfg(
            gather_keys=['spatial_fusion_feat'],
            scatter_keys=['detection'],
            gt_keys=['global_bboxes_3d', 'global_labels_3d', 'global_bboxes_mask'],
            voxel_size=voxel_size,
            point_cloud_range=point_cloud_range,
            out_stride=out_stride,
            sparse=True,
