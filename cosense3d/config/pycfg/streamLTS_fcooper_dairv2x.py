from cosense3d.config.pycfg.base.dairv2xt import *
from cosense3d.config.pycfg.base.hooks import *
from cosense3d.config.pycfg.nets.streamLTS_fcooper import *
from cosense3d.utils.train_utils import get_gpu_architecture

gpu_arc = get_gpu_architecture()
if gpu_arc >= 75:
    shared_modules = get_shared_modules(point_cloud_range,
